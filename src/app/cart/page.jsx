                ...
                <div class="bg-white px-10 py-10 sm:w-[100%] md:w-[70%]">
...

                    {
                        cart.map(ele => {
                            ...
                            return (
                                <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" id={ele.id || Math.floor(Math.random() * 1000)}>
                                    <div class="flex w-2/5">
                                        <div class="w-20">
                                            <img class="h-24" src={ele.image} alt="" />
                                        </div>
                                        <div class="flex flex-col justify-between ml-4 flex-grow">
                                            <span class="font-bold text-sm">{ele.title}</span>
                                            <span class="text-red-500 text-xs">{ele.category}</span>
                                    ...
                                    <div class="flex justify-center w-1/5">
                                        ...
                                        <input class="mx-2 border text-center w-8" type="text" value={ele.count} />
