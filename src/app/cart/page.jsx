    ...
    return (
        <div className="container mx-auto mt-10">
            <div className="flex shadow-md my-10 flex-wrap">
                <div className="bg-white px-10 py-10 sm:w-[100%] md:w-[70%]">
...

                    {
                        cart.map(ele => {
                            ...
                            return (
                                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" id={ele.id || Math.floor(Math.random() * 1000)}>
                                    <div className="flex w-2/5">
                                        <div className="w-20">
                                            <img className="h-24" src={ele.image} alt="" />
                                        </div>
                                        <div className="flex flex-col justify-between ml-4 flex-grow">
                                            <span className="font-bold text-sm">{ele.title}</span>
                                            <span className="text-red-500 text-xs">{ele.category}</span>
                                            <a href="#" className="font-semibold hover:text-red-500 text-gray-500 text-xs" onClick={() => {
                                                setCart(cart.filter(cardItem => cardItem._id != ele._id))
                                            }}>Remove</a>
                                        </div>
                                    </div>
                                    <div className="flex justify-center w-1/5">
                                        ...
                                        <input className="mx-2 border text-center w-8" type="text" value={ele.count} />
                                    ...
                                    <span className="text-center w-1/5 font-semibold text-sm">${ele.price * ele.count}</span>
                                </div>
                            )
                        })
                    }
                ...
                <div id="summary" className="sm:w-[100%] md:w-[30%] px-8 py-10">
